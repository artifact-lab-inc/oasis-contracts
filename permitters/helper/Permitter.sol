...
import {IdentityId, IIdentityRegistry} from "../../identityModule/helper/IIdentityRegistry.sol";
...
abstract contract Permitter is IPermitter, ERC165 {
    ...
    function supportsInterface(
        ...
        return
            interfaceId == type(IPermitter).interfaceId ||
    ...
    function _afterReleaseIdentity(
        IdentityId identity,
        address requester,
        bytes calldata context
    ) internal virtual {}
    ...
    function migrateSecret(
        bytes32[] calldata assigneeHash,
        IdentityId[] calldata iDs,
